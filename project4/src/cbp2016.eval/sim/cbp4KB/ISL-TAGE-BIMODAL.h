...
typedef struct {
#define MULTIDIM_TAG_SIZE           0
    UINT32 pc;                      // 18-bit tag of PC
#define MULTIDIM_CONF_MIN           0
#define MULTIDIM_CONF_MAX           0
#define LOG_MULTIDIM_CONF_SIZE      0
    int conf;                       // 4-bit confidence
#define MULTIDIM_LHIST_SIZE         0
#define LOG_MULTIDIM_LHIST_SIZE     0
...
#define MULTIDIM_LSAT_MIN           0
#define MULTIDIM_LSAT_MAX           0
#define MULTIDIM_LSAT_THRES         0
#define MULTIDIM_LSAT_SIZE          0
#define LOG_MULTIDIM_NUM_LSAT      0
    int lsat[MULTIDIM_LSAT_SIZE];   // MULTIDIM_LSAT_SIZE 5-bit saturating counters
} multidim_t;

// multi-dimensional history table
#define MULTIDIMS_SIZE              0
vector<multidim_t> multidims;       // table of multidim_t, MULTIDIMS_SIZE entries
#define MULTIDIM_REPL_SIZE          0  // plus log2(MULTIDIMS_SIZE) bits per multidim_t to maintain ranking (for replacement)

// stat correlator threshold for allocating an entry in multidims
#define MULTIDIMS_STATCOR_THRES     0
...
#define NHIST 0		// 15 tagged tables + 1 bimodal table
